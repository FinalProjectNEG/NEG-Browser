...
struct IPAddressSortingEntry {
  IPAddressSortingEntry(const std::string& ip_string,
      ...
      : string_value(ip_string), ip_address(ip_address) {   std::cout<<"\nedennnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn\n";}
...
bool SortIpAddressList(const std::string& ip_address_list,
  ...
  std::cout<<"\nSAPIRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR\n";
