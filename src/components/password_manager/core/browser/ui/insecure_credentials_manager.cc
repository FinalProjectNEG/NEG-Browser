...
InsecureCredentialsManager::GetCompromisedCredentials() const {
  ...
  std::vector<CredentialWithPassword> jj = ExtractInsecureCredentials(credentials_to_forms_, &IsCompromised);
  std::cout<<"\ninsecure_credentials_manager\n";
                std::cout<<"\n SDAROT\n";
